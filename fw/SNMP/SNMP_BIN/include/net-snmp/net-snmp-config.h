...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/root/SMC_repo/sdk/test/fw/SNMP/SNMP_BIN' '--host=arm-linux' '--disable-applications' '--with-endianness=little' '--disable-manuals' '--disable-scripts' '--enable-ipv6' '--disable-embedded-perl' '--without-perl-modules' '--enable-static=NO' '--with-openssl=/root/SMC_repo/sdk/test/fw/OpenSSL/openssl/local' '--with-persistent-directory=/tmp/net-snmp' '--with-default-snmp-version=3' '--with-sys-contact=root@' '--with-sys-location=Unknown' '--with-logfile=/tmp/snmpd.log' 'host_alias=arm-linux' 'CC=/root/SMC_repo/sdk/test/fw/ToolChain/Host/AST2400/x-tools/arm-linux/bin/arm-linux-gcc' 'CFLAGS=-Wall  -Wno-unused-function -Wno-uninitialized -Wno-unused-variable -Wno-pointer-sign -fpic -DCONFIG_PLATFORM_SUPERMICRO_X7SB3 -DKVM_VIEWER_VERSION=\"1.69.25.0x0\" -DKVM_VIEWER_LIB_VERSION=\"1.0.8\" -DSOL_VIEWER_VERSION=\"0.5.11\" -DOS_LINUX -DIPMI_RMCP_PLUS_SUB_SOL -DIPMI_RMCP_PLUS -DIPMI_RMCP_PLUS_SUB_AES -DOWN_AST_WEB_SERVER -DSMTP -DWSMAN -DIPMI_DHCP -DRAM_SENSOR_EN -DENABLE_OWN_AST_LDAP -DENABLE_AUTH_RADIUS -DBMC_VLAN -DFW_CHKSUM  -DNEW_FW_TAG -DUSER_LOCK_DISABLE -DPRESERVE_NETOWRK_SETTING -DKERNEL_START_ADDR=21400000 -DFLASH_BASE_ADDR=0x20000000 -DBOOTLOADER_NAME= -DBOOTLOADER_OFFSET=0x00000000 -DBOOTLOADER_SIZE=0x00100000 -DNVRAM_BLOCK_OFFSET=0x00100000 -DNVRAM_BLOCK_SIZE=0x00300000 -DROOTFS_OFFSET=0x00400000 -DROOTFS_SIZE=0x01000000 -DKERNEL_OFFSET=0x01400000 -DKERNEL_SIZE=0x00300000 -DWEBFS_OFFSET=0x01700000 -DWEBFS_SIZE=0x00840000 -DALL_PART_OFFSET=0x00000000 -DALL_PART_SIZE=0x01FC0000 -DBOOTLOADER_ENV_OFFSET=0x01FC0000 -DBOOTLOADER_ENV_SIZE=FLASH_ERASE_BLOCK_SIZE -DFLASH_ERASE_BLOCK_SIZE=0x00010000 -DSEL_AGING -DNODE_MAN_EN -DWSMAN_FEATURE -DDDNS_FEATURE -DNTP_FEATURE -DIPMI_DCMI_FEATURE -DNW_FIREWALL_FEATURE -DINT_VGA -I/root/SMC_repo/sdk/test/fw/IPMI/COMMON/inc/  -I/root/SMC_repo/sdk/test/fw/IPMI/COMMON/Host/AST2400/Board/AST2400_EVB/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/MSG_CHANNEL/Channel_Tbl/inc/ -I/root/SMC_repo/sdk/test/fw/USB_VD/OS/Linux/Host/AST2400/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/PS/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/MSG_BUFFER/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Session/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Chassis/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Message/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Firewall/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/NVRAM/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/SYS_BOOT/OS/Linux/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/rm_utilities/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/rm_utilities/OS/Linux/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/SENSOR_DRV/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/SENSOR_DRV/I2C/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/SENSOR_DRV/FanControl/inc -I/root/SMC_repo/sdk/test/fw/IPMI/UpdateMode/flash_drv/inc/ -I/root/SMC_repo/sdk/test/fw/Web_Server/OS/Linux/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/MSG_CHANNEL/LAN/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/MSG_CHANNEL/UART/OS/Linux/inc -I/root/SMC_repo/sdk/test/fw/IPMI/LIB_I2C/inc -I/root/SMC_repo/sdk/test/fw -I/root/SMC_repo/sdk/test/fw/IPMI/UpdateMode/inc -I/root/SMC_repo/sdk/test/fw/IPMI/SLAVE_TASK/Host/AST2400/Board/AST2400_EVB/inc -I/root/SMC_repo/sdk/test/fw/IPMI/CHASSIS_DRV/OS/Linux/Host/AST2400/Board/AST2400_EVB -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/OEM/Host/AST2400/Board/AST2400_EVB/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/OEM/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/GPIO_DRV/OS/Linux/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/UpdateMode/flash_drv/inc -I/root/SMC_repo/sdk/test/fw/IPMI/SLAVE_TASK/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/Platform/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/Platform/lib/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/PEF/inc -I/root/SMC_repo/sdk/test/fw/IPMI/SOL/inc -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Sel/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/SENSOR/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/SENSOR_DRV/HWM/inc -I/root/SMC_repo/sdk/test/fw/IPMI/SENSOR_DRV/I2C/Mux/inc -I/root/SMC_repo/sdk/test/fw/IPMI/EVENT/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Sdr/inc/ -I/root/SMC_repo/sdk/test/fw/USB_VD/OS/Linux/Host/AST2400/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/MSG_CHANNEL/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/MSG_CHANNEL/LAN/Host/H8S_2168/Board/GLOBE_BMC/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Pef/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/RMCP+_Payload/inc -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Lan/inc -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Chnl/inc -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Sensor/inc -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/WatchDog/inc -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Sol/inc -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Usr/inc -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/Serial/inc -I/root/SMC_repo/sdk/test/fw/IPMI/IPMI_CMDS/ICMB/inc -I/root/SMC_repo/sdk/test/fw/IPMI/RTOS/Linux/timer/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/RTOS/Linux/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/RTOS/Linux/lan/inc/ -I/root/SMC_repo/sdk/test/fw/IPMI/WSMAN/inc -I/root/SMC_repo/sdk/test/fw/IPMI/WSMAN/parser/XMLlib/inc -I/root/SMC_repo/sdk/test/fw/IPMI/LIB_CGI/inc -I/root/SMC_repo/sdk/test/fw/MKIMG_Tool/Host/AST2400/Board/AST2400_EVB -I/root/SMC_repo/sdk/test/fw/OpenSSL/openssl/include -Os' 'LDFLAGS=' 'LIBS='"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/root/SMC_repo/sdk/test/fw/SNMP/SNMP_BIN/share/snmp/mibs"
...
#define NETSNMP_PERSISTENT_DIRECTORY "/tmp/net-snmp"
...
#define SNMPLIBPATH "/root/SMC_repo/sdk/test/fw/SNMP/SNMP_BIN/lib/snmp"
#define SNMPSHAREPATH "/root/SMC_repo/sdk/test/fw/SNMP/SNMP_BIN/share/snmp"
#define SNMPCONFPATH "/root/SMC_repo/sdk/test/fw/SNMP/SNMP_BIN/etc/snmp"
#define SNMPDLMODPATH "/root/SMC_repo/sdk/test/fw/SNMP/SNMP_BIN/lib/snmp/dlmod"
...
#define NETSNMP_LOGFILE "/tmp/snmpd.log"
